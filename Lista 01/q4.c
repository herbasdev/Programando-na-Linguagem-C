/* QUESTÃO 04:
Um banco concederá um crédito especial aos seus clientes, variável com o saldo médio no último ano. Faça um algoritmo que calcule o valor do crédito de acordo com a tabela abaixo.
...
//calculos e resultados
  ...
  else
  {
    if (saldoMedio < 1500)
    {
      ...
      printf("Seu credito eh de %.2f e seu saldo final eh de %.2f", credito, saldoFinal);
    }
    else
    {
      if (saldoMedio < 2500)
